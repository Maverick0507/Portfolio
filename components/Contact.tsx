...
export default function Contact({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:ayushdwivedi0507@gmail.com?subject=${formData.subject}&body=${formData.message} - ${formData.name} - ${formData.email}`;
  };
      ...
      <div className="flex flex-col mt-14">
        ...
        <div className="flex flex-wrap gap-6 justify-center font-outfit text-xl font-extralight text-gray-500 mt-14">
          <p className="hover:text-black dark:hover:text-gray-300 duration-200">
            <a href="https://leetcode.com/u/Sirius_Snape/">leetcode</a>
          ...
          <p className="hover:text-black dark:hover:text-gray-300 duration-200">
            <a href="https://codeforces.com/profile/ayush_kt05">codeforces</a>
            <span className="inline-flex">
              <svg
                className="with-icon_icon__MHUeb"
                data-testid="geist-icon"
          ...
          <p className="hover:text-black dark:hover:text-gray-300 duration-200">
            <a href="https://twitter.com/dwivediayushk05">twitter</a>
            <span className="inline-flex">
              <svg
                className="with-icon_icon__MHUeb"
                data-testid="geist-icon"
          ...
          <p className="hover:text-black dark:hover:text-gray-300 duration-200">
            <a href="https://www.linkedin.com/in/ayushkdwivedi/">linkedin</a>
            <span className="inline-flex">
              <svg
                className="with-icon_icon__MHUeb"
                data-testid="geist-icon"
          ...
          <p className="hover:text-black dark:hover:text-gray-300 duration-200">
            <a href="https://github.com/Maverick0507">github</a>
            <span className="inline-flex">
              <svg
                className="with-icon_icon__MHUeb"
                data-testid="geist-icon"
