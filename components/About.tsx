...
import Designer from "public/extraImages/Designer.jpeg"
    ...
    >
      ...
      <div className="px-0 md:px-8 lg:px-20 text-black dark:text-white">
        ...
        <p className="text-sm md:text-base lg:text-lg font-light md:px-7 pt-3 font-outfit">
          ...
          <br /> <br /> Alongside my tech endeavors, I am an avid sports lover and
          a die hard potterhead. Also you may often find me thinking about my next move at {" "}
          <span className="text-blue-500 font-semibold">
            chess.com
          </span> while
          enjoying a{" "}
